...
@media screen and (min-width: 768px) {
  ...
  <body>
    ...
    <h1 style="padding-bottom: 30px; font-size:40px;"><center>Add Trainer</center></h1>
    <div class='col-md-4'></div>
        <div class='col-md-4'>
	<div class="row">
				<form method="POST" action="add-trainer.php">
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>Trainer Name</label>
								<input type="text" name="trainer_name" class="form-control" size='60'>
							</div></div>
              <div class="row">
							<div class="col-sm-12 form-group">
								<label>Skill</label>
								<input type="text" name="skill" class="form-control" size='60'>
							</div></div>
              <div  class="row">
              <div class="col-sm-12 form-group">
