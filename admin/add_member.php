...
@media screen and (min-width: 768px) {
  ...
  <body>
    ...
    <h1 style="padding-bottom: 30px; font-size:40px;"><center>Add Member</center></h1>
	...
	<div class="row">
					...
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12 form-group">
								...
								<input type="text" name="first" class="form-control" size='60'>
							</div></div>
              </div>
              <div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12 form-group">
								...
								<input type="text" name="last" class="form-control" size='60'>
							</div></div></div>
              <div class="col-sm-12">
              <div class="row">
							<div class="col-sm-12 form-group">
              ...
              <div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>Age</label>
								<input type="number" name="age" class="form-control" size='60'>
							</div></div></div>
              <div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>Gender</label>
								<input type="text" name="gender" class="form-control" size='60'>
							</div></div></div>
              <div class="col-sm-12">
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>Date of Birth</label>
								<input type="date" name="dob" class="form-control" size='60'>
							</div></div></div>
              <div class="col-sm-12">
              <div class="row">
							<div class="col-sm-12 form-group">
								<label>Phone Number</label>
								<input type="number" name="contact" class="form-control" size='60'>
							</div></div></div>
              <div class="col-sm-12">
              <div class="row">
              <div class="col-sm-12 form-group">
